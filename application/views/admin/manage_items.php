<div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <?php $new_item_attr = array('class'=>'btn btn-default btn-info'); ?>  
        <?php echo anchor('admin/add_new_item', 'New Item', $new_item_attr)?>
            ...
            <table class="table table-striped">
              ...
              <tbody>
                  ...
                  <tr>
                      ...
                      <td><?php echo anchor('admin/remove_item/'.$item->id, 'Remove'); ?></td>
                  </tr>
                  <?php endforeach; ?>
